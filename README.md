...
[![fastlane Plugin Badge](https://rawcdn.githack.com/fastlane/fastlane/master/fastlane/assets/plugin-badge.svg)](https://rubygems.org/gems/fastlane-plugin-appcircle_enterprise_app_store)
...
- `appPath`: Indicates the file path to the application that will be uploaded to the Appcircle Enterprise App Store.
